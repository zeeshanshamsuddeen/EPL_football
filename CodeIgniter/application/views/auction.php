                ...
                <div class="kf_overview_contant">
                    ...
                    <ul class="kf_table2 kf_table4 table-center">
                        <li class="table_head">
                            ...
                            <div class="tb2_hipoints">
                            </div>
                            <div class="tb2_hirebounds">
                            </div>
                            <div class="tb2_hiassists">
                            </div>
                            <div class="tb2_histeals">
                            </div>
                        </li>
                            ...
                            <li>
                                <div class="tb2_date">
                                    <span><a href="index.php/main/player_detail/<?php echo $player->ID; ?>"><?php echo $player->NAME; ?></a></span>
                                </div>
                                <div class="versus">
                                    <div><p>
                                        <b><?php echo $player->TEAM ;?></b>
                                       
                                    </p></div>
                                </div>
                                <div class="tb2_score">
                                    <span><?php echo $player->PRICE ;?></span>
                                </div>
                                <div class="tb2_status">
                                </div>
                                <div class="tb2_hipoints">
