...
TIMELINE FORM FOR GAME

    <?php echo form_open('main/timeline_form_database'); ?>

    game_id : <?php echo form_input('game_id'); ?><br>
    minute : <?php echo form_input('minute'); ?><br>
    ...
    team_id  : <?php  
           $options = array(
            ...
            echo form_dropdown('team_id', $options, '1');
    ?><br>

    goal : <?php echo form_input('goal'); ?><br>
    yellow card : <?php echo form_input('yellow'); ?><br>
    red card : <?php echo form_input('red'); ?><br>
    sub_in : <?php echo form_input('sub_in'); ?><br>
    sub_out : <?php echo form_input('sub_out'); ?><br>
