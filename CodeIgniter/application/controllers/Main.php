<?php 
	class Main extends CI_Controller{
		...
		public function index(){
			...
			$data = $this->Main_model->get_games_players_full_group_id_goals();
			$x['player_details_full_group_id_goals'] = $data;
			$data = $this->Main_model->get_games_players_full_group_id_assists();
			$x['player_details_full_group_id_assists'] = $data;
			$data = $this->Main_model->get_games_players_full_group_id_yellow();
			$x['player_details_full_group_id_yellow'] = $data;
		...
		public function latest_result(){
			...
			$x['matches'] = $data;
			$data = $this->Main_model->get_games_full();
			$x['games'] = $data;
		...
		public function gallery(){
			$this->load->model('Main_model');
			$data = $this->Main_model->get_gallery();
			$x['gallery'] = $data;
